    ...
    static Details =
        {
            ...
            details: [
                { 
                    quote: '',
                    text: 'I was born and raised in the Philippines and back home, basketball is the unofficial national sport. It is part of the Filipino culture, so much so that tradition has it to pass the ball from one generation to the next.'
                },
                { 
                    quote: '',
